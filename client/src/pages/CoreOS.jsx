...
const CoreOS = () => {
    ...
    const fetchData = async () => {
      try {
        const [topicsRes, progressRes] = await Promise.all([
          ...
          API.get(`/core/progress/${userId}?subject=OS`),
        ]);
        ...
        console.error(err);
        toast.error("Failed to load OS topics data");
      }
    };
    fetchData();
  }, [userId]);
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      >
        <h2 className="text-4xl font-bold text-white mb-3 font-serif tracking-wide">Operating Systems</h2>
