  ...
  return (
    <div className={`min-h-screen bg-slate-50 ${darkBg}`}>
      <div className="container mx-auto px-4 py-6 md:px-6 md:py-8 lg:px-8 lg:py-10">
        {/* Header */}
        <div className={`mb-8 p-6 md:p-5 lg:p-2 bg-gradient-to-r from-blue-100 to-white dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-md ${darkCardBg} ${darkBorder}`}>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            {/* Title */}
            <div className="text-center lg:text-left lg:ml-10">
              <h1 className="text-2xl md:text-4xl lg:text-4xl font-extrabold text-indigo-700 dark:text-indigo-400 flex items-center justify-center lg:justify-start gap-2 tracking-tight">
                 <span>DSA Sheet</span>
              </h1>
