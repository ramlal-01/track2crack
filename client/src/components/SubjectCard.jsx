  ...
  return (
    <motion.div
      ...
      className={`relative cursor-pointer bg-gradient-to-br from-white to-purple-50 dark:from-gray-900 dark:to-gray-800 
                 rounded-xl sm:rounded-2xl p-3 sm:p-5 shadow-lg hover:shadow-xl border border-gray-100 dark:border-gray-700 
    ...
    >
      ...
      <div className="flex justify-between items-start z-10">
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Enhanced icon container - responsive size */}
          <motion.div 
            whileHover={{ y: -2 }}
          ...
          >
            <img
              src={icon}
              alt={`${title} icon`}
              className="w-8 h-8 sm:w-10 sm:h-10 dark:invert opacity-80 dark:opacity-90"
            />
          </motion.div>
