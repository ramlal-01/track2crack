      ...
      <div className="space-y-4 lg:hidden">
          ...
          {["All", "Important", "Other", "Bookmarked", "Remind"].map((type) => (
            ...
            >
              ...
              <span className="sm:hidden text-center leading-tight">
                {type === "Important" ? "Imp" : 
                 type === "Bookmarked" ? "Book" :
                 type === "Remind" ? "Rem" : type}
              </span>
            </button>
          ))}
        </div>
        ...
        <div className="relative">
          <input
            ...
            className={`pl-10 pr-4 py-3 sm:py-2 w-full rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 hover:border-gray-400 transition-colors text-sm ${darkInput}`}
          />
