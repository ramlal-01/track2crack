...
const TopicRow = ({
  ...
  return (
    <>
      ...
      <div
        className={`hidden lg:grid lg:grid-cols-[100px_6fr_1fr_1fr_1fr_1.5fr_1fr_200px] items-center p-4 rounded-xl transition-all border-gray-200 ${
          isCompleted 
        ...
        <div className="flex justify-center">
          {yt ? (
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className={`hover:scale-125 transition-transform duration-200 text-red-600 hover:text-red-700 dark:text-red-500 dark:hover:text-red-400 ${!isEnabled ? 'opacity-50 pointer-events-none' : ''}`}
        ...
        <div className="flex justify-center">
          <button
            ...
            className={`hover:scale-125 transition-transform duration-200 ${
              canAttemptQuiz 
                ? "text-purple-600 hover:text-purple-700 dark:text-purple-500 dark:hover:text-purple-400" 
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Hide topic.notes in mobile view */}
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3">
            <div ref={(el) => (reminderRefs.current[topic._id] = el)} className="relative flex-1">
              ...
              {openReminderId === topic._id && (
                <div className={`absolute z-50 top-full mt-1 left-0 bg-white border border-gray-200 shadow-lg rounded-lg p-2 ${darkCardBg} ${darkBorder}`}>
                  <DatePicker
                    selected={remindOn ? new Date(remindOn) : null}
                    onChange={(date) => handleReminderChange(topic._id, date)}
                    dateFormat="dd/MM/yyyy"
