  ...
  return (
    <header className="sticky top-0 z-50 w-full h-[72px] bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 text-white shadow-md flex items-center px-4 sm:px-6 md:px-10 justify-between">
      ...
      <div className="flex items-center">
        ...
        {isDashboardPage && (
          <button 
            ...
            className="p-2 mr-2 sm:mr-3 rounded-xl bg-white/10 hover:bg-white/20 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/50"
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        {/* 🔥 Streak - Show on all screen sizes */}
        <StreakBadge />
      {/* 👤 Avatar + dropdown */}
        <div className="flex items-center">
          <TopRightAvatar />
